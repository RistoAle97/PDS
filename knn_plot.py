...
if __name__ == "__main__":
    ...
    knn_p_10k = np.array([4195076, 2150114, 1053365, 586849, 322046, 182296, 133958, 99786, 99371])
    knn_p_20k = np.array([16573213, 8006220, 4072286, 2030168, 1087086, 677542, 434134, 308973, 256716])
    knn_p_50k = np.array([98816008, 50251728, 24916862, 12161390, 6741971, 3472759, 2151317, 1590471, 1046949])
